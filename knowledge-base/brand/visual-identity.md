...
Ika's hair gradient is sacred and must be consistent:

```
Rose Pink (#FF6B9D) → Magenta (#FF2D7B)
```
...
| Usage | Typeface | Characteristics |
|-------|----------|-----------------|
| **Headlines** | Cinzel Decorative | Elegant, premium, authority |
| **Subheadlines** | Montserrat Bold | Modern, confident, clean |
| **Body Text** | Source Sans Pro | Readable, professional, warm |
| **Accent/UI** | Rajdhani | Tech-forward, sharp, game-ready |
...
```
THE CHASE BEGINS
Premium limited banner • 24 hours only
```
...
The Infinite Idol logo consists of:

1. **Wordmark**: "INFINITE IDOL" in Cinzel Decorative
2. **Icon**: Stylized infinity symbol integrated with idol silhouette
...
## Midjourney/AI Art Direction

When generating visual assets, use these prompt anchors:
...
- `knowledge-base/brand/voice-and-tone.md` - Verbal brand expression
- `knowledge-base/brand/target-audience.md` - Who we're designing for
- `knowledge-base/brand/competitors.md` - Visual differentiation
- `outputs/art/midjourney-prompts/` - Generated prompt templates
- `agents/06-asset-coordinator.md` - Asset creation workflows
